...
/* Standard includes. */
#include "../../../application/rv32-rtos-cli/full_demo/UARTCommandConsole.h"
...
static void prvUARTRxNotificationHandler( UART_instance_t * this_uart );
...
static void prvConfigureUART( void )
{
	...
	/* need to use the  irq of the processor to trigger this and call  prvUARTRxNotificationHandler, whenever the uart_rxrdy comes
	 * */

}
/*-----------------------------------------------------------*/

static void prvUARTRxNotificationHandler( UART_instance_t * pxUART )
{
char cRxed;
portBASE_TYPE xHigherPriorityTaskWoken;
	...
	if( UART_get_rx( pxUART, ( uint8_t * ) &cRxed, sizeof( cRxed ) ) == sizeof( cRxed ) )
	{
