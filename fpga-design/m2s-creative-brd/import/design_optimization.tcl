...
#import_files -io_pdc $scriptDir/import/constraints/M2S_CREATIVE/io_constraints.pdc
#import_files -io_pdc $scriptDir/import/constraints/M2S_CREATIVE/uart_constraints.pdc
#import_files -sdc $scriptDir/import/constraints/M2S_CREATIVE/io_jtag_constraints.sdc
#import_files -net_fdc $scriptDir/import/constraints/M2S_CREATIVE/global.fdc
...
if {$config in {"CFG1" "CFG2" "CFG3" "DGC1" "DGC3" "DGC4"}} then {
	import_files -io_pdc $scriptDir/import/constraints/M2S_CREATIVE/io/io_constraints.pdc
	import_files -io_pdc $scriptDir/import/constraints/M2S_CREATIVE/io/uart_constraints.pdc
	import_files -sdc $scriptDir/import/constraints/M2S_CREATIVE/timing/io_jtag_constraints.sdc

	if {$config in { "CFG2" "CFG3"}} {
		import_files -io_pdc $scriptDir/import/constraints/M2S_CREATIVE/io/spi_constraints.pdc
